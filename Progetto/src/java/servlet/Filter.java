...
public class Filter extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (command != null) {
            ...
            if (command.equals("q")) {
                ArrayList<Mooseca> listaMusica;

                if (!request.getParameter("valore").equals("")) {
                    System.out.println((String) request.getParameter("valore"));
                    listaMusica = MoosecaFactory.getInstance().getMusica((String) request.getParameter("valore"));
                } else {
                    listaMusica = MoosecaFactory.getInstance().getMusica();
                }
                ...
                request.getRequestDispatcher("listaMusicaJson.jsp").forward(request, response);
            }
        }
    }
